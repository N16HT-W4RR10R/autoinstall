...
Created by Blackode32 on 27/11/2019.
...
def main_menu():
       ...
       slowprint(W + '| Author'+m+'  :'+g+' '+M+'Blackode32'+W+'                    |')
       slowprint(W + '| Support '+m+':'+M+' '+k+'Unixode7'+W+'                      |')
       slowprint(W + '| Github  '+m+':'+M+' '+p+'https://github.com/blackode32'+W+' |')
       slowprint(W + '| Contact '+m+':'+M+' '+u+'https://t.me/blackode32'+W+'       |')
       slowprint(W + '#'*43)
...
def about():
    clear()
    slowprint(W + '-'*43)
    slowprint(W + '|    '+b+'author : Blackode32'+W+'                  |')
    slowprint(W + '|    '+b+'contact : t.me/blackode32'+W+'            |')
    slowprint(W + '-'*43)
    print(k+"segala yang terjadi saat menggunakan tools ini ditanggu oleh pengguna\nJika terjadi error/bug harap hubungi saya")
    print(gt+"terima kasih kepada : Allah SWT, Unixode7, dan kepada diri saya sendiri hehe"+W)
    tanya()
